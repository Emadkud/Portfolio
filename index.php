					...
					<figure>
				      ...
				      <p>
							Je m’appelle <strong>Emad MUSTAFA</strong> , développeur Web junior.
						     ...
						     <a href="images/CVEmad...pdf" class="btn downloadCV" download>
		...
		<section id="page-3" class="page">
			<div class="container">
				...
				<ul>
					...
					<li class="project">
						<figure class="project_Image">
							<img src="images/tradu.jpg" />
							<div class="project-links">
								<a href="http://"><i class="fas fa-hand-point-up"></i></a>
								<a href="#"><i class="fas fa-arrow-up"></i></a>
							</div>
						</figure>
						<h4>Projet site pour un Traducteur (À VENIR)</h4>
					</li>
					<li class="project">
						<figure class="project_Image">
						...
						<h4>Projet site Agence Immobilier(À VENIR)</h4>
					</li>
					<li class="project">
						<figure class="project_Image">
			...
			<div >
				...
				<a href="./images/CVEmad...pdf class="fas fa-user-tie"></i></a>
				<a href="https://twitter.com/basemmostafa7"><i class="fab fa-twitter"></i></a>
				  ...
				  <div class="contact-form">					<h2>Nous Contacter</h2>
